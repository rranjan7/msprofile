...
//    private static final java.io.File DATA_STORE_DIR = new java.io.File(System.getProperty("user.home"), ".credentials/sheets.googleapis.com-java-quickstart");
    private static final java.io.File DATA_STORE_DIR = new java.io.File(System.getProperty("user.home"), ".credentials/22/sheets.googleapis.com-java-quickstart.json");
...
//        String range = "USD!3:10";
        ...
        String range;
        List<String> price = Arrays.asList("USD!3:10","AUD!3:10","EUR!3:10","GBP!3:10");
        for(int i=0; i<4;i++) 
        {          
            range = price.get(i);
